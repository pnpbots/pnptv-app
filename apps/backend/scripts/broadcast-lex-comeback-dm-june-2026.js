...
/**
 * broadcast-lex-comeback-dm-june-2026.js
 *
 * In-app DM from PNPLATINOBOY / Lex (7246621722) to all non-Spanish-speaking
 * users letting them know he's back and creating content.
 *
 * Usage:
 *   docker exec pnptv-bot node apps/backend/scripts/broadcast-lex-comeback-dm-june-2026.js --dry-run
 *   docker exec pnptv-bot node apps/backend/scripts/broadcast-lex-comeback-dm-june-2026.js
 */
...
const BROADCAST_ID = 'lex-comeback-dm-june-2026';
const BATCH_SIZE   = 200;

const MESSAGE = `Hey guys! 👋 Just wanted to pop in and say — I'm back! 🙌 Been away for a bit but I'm here now and already creating content again 🎥 Can't wait for you to see what's coming. Stay tuned 😘`;

async function main() {
  console.log('\n═══════════════════════════════════════════════════');
  console.log(' Lex Comeback DM — non-Spanish users — June 2026');
  console.log('═══════════════════════════════════════════════════');
