...
/**
 * broadcast-lifetime100.js
 *
 * Lifetime PRIME broadcast — $100 card + crypto offer at /lifetime100.
 * Announces the /lifetime100 page to all active members.
 *
 * Usage:
 *   docker exec pnptv-bot node apps/backend/scripts/broadcast-lifetime100.js --dry-run
 *   docker exec pnptv-bot node apps/backend/scripts/broadcast-lifetime100.js
 *   docker exec pnptv-bot node apps/backend/scripts/broadcast-lifetime100.js --skip-email
 *   docker exec pnptv-bot node apps/backend/scripts/broadcast-lifetime100.js --skip-telegram
 */
...
const ENTITY_ID     = 'lifetime100-launch-2026-06';
const PAGE_URL      = 'https://pnptv.app/lifetime100';
...
const NOTIFICATION_MSG = {
  en: `🔥 Lifetime PRIME — $100 one-time. Pay with card, Dash, or USDC. Full PRIME forever. No renewals, ever. Also: monthly & yearly plans at pnptv.app/subscribe →`,
  es: `🔥 Lifetime PRIME — $100 pago único. Paga con tarjeta, Dash o USDC. PRIME completo para siempre. Sin renovaciones. También: planes mensuales y anuales en pnptv.app/subscribe →`,
};

const PUSH = {
  en: {
    title: '🔥 Lifetime PRIME — $100 one-time',
    body:  'Pay with card, Dash, or USDC. Full PRIME forever. No renewals, ever. Monthly & yearly plans also available.',
  },
  es: {
    title: '🔥 Lifetime PRIME — $100 único pago',
...
const TG = {
  en:
`🔥 <b>Lifetime PRIME — $100. One payment. Forever.</b>

An exclusive offer for the community:

<b>Lifetime PRIME for $100</b> — pay once, access forever.

No monthly fees. No renewals. <b>Just $100 and it's yours for life.</b>
...
<b>Three ways to pay — all $100 flat:</b>
...
👉 <a href="${SUBSCRIBE_URL}">${SUBSCRIBE_URL}</a>`,
  ...
  es:
`🔥 <b>Lifetime PRIME — $100. Un pago. Para siempre.</b>

Una oferta exclusiva para la comunidad:

<b>Lifetime PRIME por $100</b> — paga una vez, acceso para siempre.

Sin cuotas mensuales. Sin renovaciones. <b>Solo $100 y es tuyo de por vida.</b>
...
<b>Tres formas de pagar — todas a $100 fijo:</b>
...
const EMAIL_SUBJECT = {
  en: '🔥 Lifetime PRIME — $100 one-time — pay with card, Dash, or USDC. Yours forever.',
  es: '🔥 Lifetime PRIME — $100 pago único — paga con tarjeta, Dash o USDC. Tuyo para siempre.',
};
...
<head>
  ...
  <title>${en ? 'Lifetime PRIME — $100 One-Time' : 'Lifetime PRIME — $100 Pago Único'}</title>
</head>
      ...
      <table width="600" cellpadding="0" cellspacing="0" style="max-width:600px;width:100%;background:#120d14;border-radius:16px;overflow:hidden;border:1px solid rgba(38,161,123,0.30);">
        ...
        <tr><td style="padding:16px 32px 32px;">
          ...
          <h1 style="margin:0 0 8px;font-size:26px;font-weight:900;color:#ffffff;line-height:1.15;">
            🔥 ${en ? 'Lifetime PRIME — $100. One payment. Forever.' : 'Lifetime PRIME — $100. Un pago. Para siempre.'}
          </h1>
          ...
          <table width="100%" cellpadding="0" cellspacing="0" style="margin-bottom:24px;">
            <tr><td style="padding:24px;background:rgba(38,161,123,0.08);border:1px solid rgba(38,161,123,0.30);border-radius:16px;text-align:center;">
              ...
              <p style="margin:0;font-size:56px;font-weight:900;color:#26a17b;line-height:1;text-shadow:0 0 30px rgba(38,161,123,0.4);">$100</p>
          ...
          <!-- Payment methods -->
          <p style="margin:0 0 12px;font-size:15px;font-weight:800;color:#ffffff;">
            ${en ? 'Three ways to pay — all $100 flat:' : 'Tres formas de pagar — todas a $100 fijo:'}
          </p>
          <table width="100%" cellpadding="0" cellspacing="0" style="margin-bottom:24px;">
            <tr>
...
async function main() {
  console.log('\n═══════════════════════════════════════════════════');
  console.log(' Lifetime PRIME $100 Broadcast');
  console.log('═══════════════════════════════════════════════════');
