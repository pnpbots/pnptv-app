...
/**
 * broadcast-mr8502-intro-dm-june-2026.js
 *
 * In-app DM from MR8502 to all users (Spanish only — all users get Spanish).
 *
 * Usage:
 *   docker exec pnptv-bot node apps/backend/scripts/broadcast-mr8502-intro-dm-june-2026.js --dry-run
 *   docker exec pnptv-bot node apps/backend/scripts/broadcast-mr8502-intro-dm-june-2026.js
 */
...
const SENDER_ID    = 'ee09336c-9442-4c30-9e88-f739ee799415'; // MR8502
const BROADCAST_ID = 'mr8502-intro-dm-june-2026';
...
async function main() {
  console.log('\n═══════════════════════════════════════════════════');
  console.log(' MR8502 Intro DM — all users — June 2026');
  console.log('═══════════════════════════════════════════════════');
