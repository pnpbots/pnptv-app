...
// ---------------------------------------------------------------------------
// LatamUpsell — shown to LATAM non-PRIME users
// ---------------------------------------------------------------------------
function LatamUpsell() {
  const navigate = useNavigate();

  const features: Feature[] = [
    {
      icon: "M17 20h5v-2a3 3 0 00-5.356-1.857M17 20H7m10 0v-2c0-.656-.126-1.283-.356-1.857M7 20H2v-2a3 3 0 015.356-1.857M7 20v-2c0-.656.126-1.283.356-1.857m0 0a5.002 5.002 0 019.288 0M15 7a3 3 0 11-6 0 3 3 0 016 0z",
      label: "Social feed & community posts",
    },
    {
      icon: "M15 10l4.553-2.276A1 1 0 0121 8.618v6.764a1 1 0 01-1.447.894L15 14M5 18h8a2 2 0 002-2V8a2 2 0 00-2-2H5a2 2 0 00-2 2v8a2 2 0 002 2z",
      label: "Hangouts & live video rooms",
    },
    {
    ...
    {
      icon: "M5.636 18.364a9 9 0 010-12.728M12 21a9 9 0 000-18M9 12a3 3 0 106 0 3 3 0 01-6 0",
      label: "PNP Live streams",
    },
  ];
    ...
    <div className="page-container flex items-center justify-center min-h-[60vh]">
      <Card className="max-w-md w-full p-6">
        <div className="text-center mb-6">
          ...
          <h2 className="text-xl font-bold text-pnp-textPrimary mb-2">
            PRIME Required in Latin America
          </h2>
          <p className="text-sm text-pnp-textSecondary">
            This feature is available exclusively for PRIME members in Latin America.
            Upgrade to unlock the full PNPtv! experience.
          </p>
        </div>
