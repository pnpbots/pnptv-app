...
export function VideoCallBanner({
  ...
  return (
    <div
      className={`mx-3 mt-2 flex-shrink-0 transition-all duration-300 ease-out ${
        mounted
    ...
    >
      <div
        ...
        style={{ background: "linear-gradient(135deg, rgba(94,209,196,0.12), rgba(123,97,255,0.12))" }}
      >
        <div className="flex items-center gap-3">
          {/* Animated call icon */}
          <div className="flex-shrink-0 w-10 h-10 rounded-full flex items-center justify-center" style={{ background: "rgba(94,209,196,0.2)" }}>
          ...
          <div className="flex-1 min-w-0">
            <div className="flex items-center gap-2 flex-wrap">
              ...
              {callStartedAt && (
                <span className="text-[11px] font-mono text-pnp-textSecondary/80 tabular-nums px-1.5 py-0.5 rounded-md bg-white/5">
                  {duration}
                </span>
              )}
              {isSomeoneSharing && (
            ...
            <div className="flex items-center gap-2 mt-1.5">
              ...
              {participantCount === 0 && (
                <span className="text-xs text-pnp-textSecondary">Waiting for participants...</span>
              )}
            </div>
          </div>
          ...
          <button
            onClick={onJoin}
            disabled={isJoining}
            className="flex-shrink-0 flex items-center gap-1.5 px-4 py-2.5 rounded-xl text-sm font-bold text-white active:scale-95 transition-all disabled:opacity-50 disabled:cursor-not-allowed focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-pnp-accent focus-visible:ring-offset-2 focus-visible:ring-offset-pnp-background shadow-lg"
