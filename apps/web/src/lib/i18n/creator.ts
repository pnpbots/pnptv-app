const strings = {
  en: {
    ...
    cryptoInputHint: "Legacy USDC payouts — your Ethereum wallet address (EVM, 0x...). New creators should pick Dash above.",
  ...
  es: {
    ...
    cryptoInputHint: "Pagos USDC legacy — tu dirección de wallet Ethereum (EVM, 0x...). Los nuevos creadores deberían elegir Dash arriba.",
    cryptoPlaceholder: "0x...",
