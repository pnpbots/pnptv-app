const strings = {
  en: {
    ...
    cryptoP2:
      "You don’t need to be a crypto expert. The wallets below make it easy. You can buy crypto directly inside either app using a debit card.",
    ...
    cryptoTrustTitle: "Trust Wallet",
    cryptoTrustDesc: "Recommended for USDC, USDT, and other coins. Supports dozens of blockchains.",
    cryptoTrustHomepage: "https://trustwallet.com/download",
    cryptoTrustAppStore: "https://apps.apple.com/app/trust-crypto-bitcoin-wallet/id1288339409",
    cryptoTrustPlayStore: "https://play.google.com/store/apps/details?id=com.wallet.crypto.trustapp",
  ...
  es: {
    ...
    cryptoP2:
      "No necesitas ser un experto en cripto. Las billeteras a continuación lo hacen fácil. Puedes comprar cripto directamente dentro de cualquiera de las apps con tu tarjeta de débito.",
    cryptoDashTitle: "DashPay",
    ...
    cryptoDashPlayStore: "https://play.google.com/store/apps/details?id=hashengineering.darkcoin.wallet",
    cryptoTrustTitle: "Trust Wallet",
    cryptoTrustDesc: "Recomendado para USDC, USDT y otras monedas. Compatible con docenas de blockchains.",
    cryptoTrustHomepage: "https://trustwallet.com/download",
    cryptoTrustAppStore: "https://apps.apple.com/app/trust-crypto-bitcoin-wallet/id1288339409",
    cryptoTrustPlayStore: "https://play.google.com/store/apps/details?id=com.wallet.crypto.trustapp",
