const strings = {
  en: {
    ...
    usdcWaitingDesc: "Complete payment in the NOWPayments window. This page updates automatically when confirmed.",
    usdcPaymentConfirmed: "Payment confirmed!",
    usdcExpired: "USDC payment expired. Please try again.",
    ...
    dashNotConfigured: "Dash payments are not available yet. Please use Card / Stripe instead.",
  ...
  es: {
    ...
    usdcBadge: "ESTABLE",
    usdcInfoText: "Paga con USDC o USDT — valor estable, sin volatilidad, aceptado desde cualquier red. Elige tu red preferida en el pago.",
    usdcRedirecting: "Abriendo pago seguro...",
    usdcWaitingTitle: "Esperando pago USDC",
    usdcWaitingDesc: "Completa el pago en la ventana de NOWPayments. Esta página se actualiza automáticamente cuando se confirme.",
    usdcPaymentConfirmed: "¡Pago confirmado!",
    usdcExpired: "El pago USDC expiró. Por favor, inténtalo de nuevo.",
    ...
    dashNotConfigured: "Los pagos con Dash no están disponibles aún. Por favor usa Tarjeta / Stripe.",
  ...
  pt: {
    ...
    usdcExpired: "Pagamento USDC expirado. Por favor, tente novamente.",
