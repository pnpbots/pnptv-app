const strings = {
  en: {
    ...
    tutTopicNearby: "PNP Connect",
    tutTopicHangouts: "Hangouts & Video Rooms",
    tutTopicPrime: "PRIME Membership",
    tutTopicCreator: "Become a Creator",
    tutTopicPayments: "Payment Methods",
    tutTopicTokens: "PNP Fichas",
    tutTopicDms: "Direct Messages",
  ...
  es: {
    ...
    tutTopicNearby: "PNP Connect",
    tutTopicHangouts: "Hangouts y Salas de Video",
    tutTopicPrime: "Membresía PRIME",
    tutTopicCreator: "Ser Creador",
    tutTopicPayments: "Métodos de Pago",
    tutTopicTokens: "Fichas PNP",
    tutTopicDms: "Mensajes Directos",
