...
const STEPS = [
  {
    ...
    desc: "Open app.pnptv.app/subscribe or tap the Subscribe button in the app.",
    icon: (
  ...
  },
  {
    ...
    desc: 'On the payment screen, you\'ll see three tabs: Card/PSE, USDC, and Dash. Tap the ninja emoji tab — that\'s Dash.',
    icon: (
      <svg className="w-7 h-7" fill="none" viewBox="0 0 24 24" stroke="currentColor" strokeWidth={1.5}>
            ...
            <div className="space-y-3">
              {[
                ...
                },
                {
                  ...
                  a: "We also accept USDC stablecoin payments through Daimo. Check the USDC tab on the subscribe page. But Dash offers the best privacy of all our payment options.",
                },
                {
