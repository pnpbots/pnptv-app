            ...
            <div className="space-y-3">
              {[
                ...
                },
                {
                  ...
                  a: "Right now, Dash is our only crypto payment option. For non-crypto payments we accept Visa/Mastercard via Stripe on the Subscribe page. Dash offers the strongest privacy.",
                },
                {
