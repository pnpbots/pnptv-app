        ...
        <div className="fixed inset-0 z-50 flex items-end justify-center bg-black/60 backdrop-blur-sm" onClick={() => setShowGoLive(false)}>
          <div className="w-full max-w-lg bg-pnp-background border border-pnp-border rounded-t-2xl p-6" onClick={(e) => e.stopPropagation()}>
            ...
            <button
              ...
              className="w-full flex items-center gap-3 p-4 rounded-xl border border-pnp-accent/30 bg-pnp-accent/5 hover:bg-pnp-accent/10 transition-colors mb-3"
            >
            ...
            <button
              ...
              className="w-full flex items-center gap-3 p-4 rounded-xl border border-pnp-border bg-pnp-surface hover:bg-pnp-surface/80 transition-colors"
            >
              <div className="w-10 h-10 rounded-full bg-pnp-border flex items-center justify-center flex-shrink-0">
              ...
              <div className="text-left">
                <p className="text-sm font-medium text-pnp-textPrimary">Use OBS / external software</p>
                <p className="text-xs text-pnp-textSecondary">RTMP server & stream key</p>
              </div>
              <svg className={`w-4 h-4 text-pnp-textSecondary ml-auto flex-shrink-0 transition-transform ${showRtmpDetails ? "rotate-180" : ""}`} fill="none" viewBox="0 0 24 24" stroke="currentColor">
                <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M19 9l-7 7-7-7" />
              </svg>
            </button>
